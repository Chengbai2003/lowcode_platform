 ...
 */
export const switchAction: ActionHandler = async (
  action,
  context,
  executor,
) => {
...
export const loopAction: ActionHandler = async (action, context, executor) => {
  ...
  for (let i = 0; i < resolvedOver.length; i++) {
    ...
    const result = await executor.execute(
      actions,
      loopContext as ExecutionContext,
    );
    results.push(result);
  }
 ...
 */
export const parallelAction: ActionHandler = async (
  action,
  context,
  executor,
) => {
 ...
 */
export const sequenceAction: ActionHandler = async (
  action,
  context,
  executor,
) => {
 ...
 */
export const tryCatchAction: ActionHandler = async (
  action,
  context,
  executor,
) => {
