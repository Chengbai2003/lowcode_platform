...
describe('UpdateSchemaCommand', () => {
  ...
  it('should create command with correct properties', () => {
    const command = createUpdateSchemaCommand(oldSchema, newSchema, mockOnChange);
...
describe('ComponentCommand', () => {
  ...
  describe('add operation', () => {
    it('should add component to schema', () => {
      ...
      const command = createAddComponentCommand(newComponent, 'root', mockGetSchema, mockSetSchema);
    ...
    it('should undo add operation', () => {
      ...
      expect(updatedSchema.components.root.childrenIds).not.toContain('newChild');
    });
  });
