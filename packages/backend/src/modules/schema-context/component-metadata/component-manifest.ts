/**
 * Component manifest — single source of truth for backend + frontend codegen.
 *
 * This file holds pure data (REGISTRY + ALIASES) so that
 * component-meta.registry.ts can stay a thin registry facade.
 * Future step: generate frontend/src/components/componentMeta.ts from this manifest
 * and add CI checksum to prevent drift.
 *
 * @module schema-context/component-metadata/manifest
 */

import type { BackendComponentMeta } from './component-meta.types';

export const REGISTRY: readonly BackendComponentMeta[] = [
  // --- layout ---
  {
    type: 'Container',
    displayName: '容器',
